...
const MyBookings = () => {
  ...
  const completedCount = bookings.filter(b => b.status === "Completed" || b.status === "Accepted").length;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {bookings.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-center justify-between hover:shadow-md transition-all">
              <div>
                <p className="text-gray-500 text-sm font-medium">Acceptedted</p>
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredBookings.map((booking) => {
                ...
                const isUpcoming = bookingDate > new Date() && booking.status === "Pending";
